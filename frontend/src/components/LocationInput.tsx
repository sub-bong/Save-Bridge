  ...
  return (
    <section className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
      ...
      <div className="flex flex-col md:flex-row gap-3 items-end">
        ...
        <button
          className="md:w-24 h-12 rounded-lg bg-slate-700 text-white text-base font-semibold flex items-center justify-center hover:bg-slate-800 active:bg-slate-900 transition shadow-md"
