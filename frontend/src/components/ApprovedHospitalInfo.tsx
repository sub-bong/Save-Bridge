...
export const ApprovedHospitalInfo: React.FC<ApprovedHospitalInfoProps> = ({ approvedHospital }) => {
  return (
    <section className="bg-white rounded-lg shadow-md p-6 border-2 border-green-600">
      <h2 className="text-lg font-bold mb-3 text-green-800 border-b-2 border-green-600 pb-2">승인된 병원</h2>
