...
### 문제 5: "ngrok URL이 자동으로 감지되지 않았습니다"
...
| **ngrok URL 확인** | `curl -s http://localhost:4040/api/tunnels \| python3 -c "import sys, json; print(json.load(sys.stdin)['tunnels'][0]['public_url'])"` |
| **포트 사용 확인** | `lsof -i :5001` |
